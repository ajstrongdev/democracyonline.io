...
function SenateBills() {
  ...
  const {
    ...
    queryKey: ["senateVotes", data.map((bill: BillItem) => bill.id)],
    queryFn: async () => {
              ...
              <Card key={bill.id} className="flex flex-col">
                ...
                <CardFooter className="flex-col items-start gap-3">
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    either pass to the Oval Office for signature or be defeated.
                  </p>
                </CardFooter>
              </Card>
            ))}
...
export default withAuth(SenateBills);
