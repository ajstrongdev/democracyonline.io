...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] space-y-4 px-4">
      <Frown className="mx-auto" size={48} />
      <h1 className="text-center text-4xl">Oops!</h1>
      <p className="text-center">
        Registration is currently disabled while we resolve some issues. Please
        check back later.
      </p>
    </div>
  );
