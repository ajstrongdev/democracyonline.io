    ...
    <div className="">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center px-4 py-12 md:py-20">
        ...
        <div className="relative z-10 w-full text-center space-y-8">
          ...
          >
            <span className="block bg-linear-to-r from-green-600 via-primary to-blue-600 dark:from-green-400 dark:via-primary dark:to-blue-400 bg-clip-text text-transparent">
              Your Voice.
            </span>
              ...
              >
                <Card className="h-full border-2 hover:border-primary/50 transition-all hover:shadow-xl group">
                  <CardContent className="p-6 md:p-8">
                    <div
                      className={`w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-linear-to-br ${feature.gradient} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}
                    >
      ...
      {/* Final CTA Section */}
      <section className="px-4 md:px-8 lg:px-12 py-12 md:py-20 bg-linear-to-br from-green-50 via-background to-blue-50 dark:from-green-950/20 dark:via-background dark:to-blue-950/20">
